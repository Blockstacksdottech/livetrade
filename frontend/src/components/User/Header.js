...
function Header(props){
  ...
  <div className="container d-flex align-items-center justify-content-between">
    ...
    <nav id="navbar" className="navbar">
      <ul>
        <li><Link to="/userpanel/dashboard" className={props.loc == "dashboard" ? "nav-link scrollto active" : "nav-link scrollto" }   href="admin-dashboard.html">Dashboard</Link></li>
        <li><Link to="/userpanel/config" className={props.loc == "config" ? "nav-link scrollto active" : "nav-link scrollto" } href="add-user.html">Config</Link></li>
