...
class PrivateApi(Base):
    ...
    def get_user_orders(self, **params):
        ...
        check_args(params, optional_parameters={"start_date": str,
                                                ...
                                                "page_size": int,
                                                "current_page": int,
                                                "pair": ['BRL1INCH',  'BRLBCH', 'BRLBTC', 'BRLDAI', 'BRLDOT', 'BRLENS', 'BRLEOS', 'BRLETH', 'BRLKSM', 'BRLLTC', 'BRLRPC', 'BRLSPELL', 'BRLUNI', 'BRLUSDC', 'BRLXRP']})
    ...
    def estimated_price(self, **params):
        ...
        :param str type: buy/sell
        """
        check_args(params, {"pair": ['BRL1INCH',  'BRLBCH', 'BRLBTC', 'BRLDAI', 'BRLDOT', 'BRLENS', 'BRLEOS', 'BRLETH', 'BRLKSM', 'BRLLTC', 'BRLRPC', 'BRLSPELL', 'BRLUNI', 'BRLUSDC', 'BRLXRP'],
                            "amount": float,
                            "type": ["buy", "sell"]})
